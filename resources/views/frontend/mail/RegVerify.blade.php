            ...
            <table bgcolor="#ffffff" width="50%" cellpadding="30" cellspacing="0" border="0" align="center" class="devicewidth" modulebg="edit" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-radius: 3px;">
                ...
                <tr>
                    <td style="border-collapse: collapse; font-family: OpenSans, arial, sans-serif; font-size: 17px; color: #999999; text-align:left;;line-height: 30px; padding-bottom: 0px; padding-top: 30px;" st-content="fulltext-paragraph">
                        ...
                        <br>
                        <br>
                        <span style="color: #999999;text-align: center;margin: 0 auto">To active your account click on the bellow button . </span>
                    </td>
                </tr>

                <tr>
                    <td style="border-collapse: collapse; padding-top: 20px; padding-bottom: 50px;">
                        <table height="36" align="center" valign="middle" border="0" cellpadding="0" cellspacing="0" class="tablet-button" st-button="edit" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; ">
                            <tbody>
                            <tr>
                                <td width="auto" valign="middle" height="40" style="border-collapse: collapse;  background-color:#6bc149; border-top-left-radius:4px; border-bottom-left-radius:4px;border-top-right-radius:4px; border-bottom-right-radius:4px; background-clip: padding-box;font-size:18px; font-family: OpenSans, arial, sans-serif; text-align:center;  color:#ffffff; font-weight: 300; padding-left:25px; padding-right:25px;">
                            <span style="color: #ffffff;">
                                            <a href="{{$msg['vlink']}}" target="_blank" style="text-decoration: none; color: #fff;">Verify Your Email</a>
                                        </span>
                                </td>
                            </tr>
                            </tbody>
