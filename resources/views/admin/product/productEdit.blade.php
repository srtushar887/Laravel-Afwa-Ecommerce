                    ...
                    <form class="needs-validation" novalidate="" action="{{route('admin.update.product')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="product_old_price" value="{{$product->product_old_price}}" class="form-control" >
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustom01">Product New Price</label>
                                <input type="number" name="product_new_price" value="{{$product->product_new_price}}" class="form-control" >
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control" name="top_cat_id">
                                    ...
                                    @foreach($top_cats as $tcat)
                                        <option value="{{$tcat->id}}" {{$product->top_cat_id == $tcat->id ? 'selected' : ''}}>{{$tcat->category_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control" name="mid_cat_id">
                                    ...
                                    @foreach($mid_cats as $mcat)
                                        <option value="{{$mcat->id}}" {{$product->mid_cat_id == $mcat->id ? 'selected' : ''}}>{{$mcat->category_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control" name="end_cat_id">
                                    ...
                                    @foreach($end_cats as $ecat)
                                        <option value="{{$ecat->id}}" {{$product->end_cat_id == $ecat->id ? 'selected' : ''}}>{{$ecat->category_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" name="is_hot_deal">
                                    <option value="0">select any</option>
                                    <option value="1" {{$product->is_hot_deal == 1 ? 'selected' : ''}}>Yes</option>
